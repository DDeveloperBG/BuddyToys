namespace WishlistService.Infrastructure
{
    ...
    using WishlistService.Common;
    using WishlistService.DTOs;
    using WishlistService.Services.MessageBus;
    ...
    public static class ServiceCollectionExtensions
    {
           ...
           this IServiceCollection serviceCollection)
        {
            serviceCollection
                .AddDataProtection()
                .PersistKeysToFileSystem(new DirectoryInfo(@"../.aspnet/wishlist-service/DataProtection-Keys"))
