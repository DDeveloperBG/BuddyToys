namespace ItemReadService.Infrastructure
{
    ...
    using ItemReadService.Common;
    using ItemReadService.DTOs;
    using ItemReadService.Services.MessageBus;
    ...
    public static class ServiceCollectionExtensions
    {
           ...
           this IServiceCollection serviceCollection)
        {
            serviceCollection
                .AddDataProtection()
                .PersistKeysToFileSystem(new DirectoryInfo(@"../.aspnet/item-read-service/DataProtection-Keys"))
