namespace ItemSearchService.Infrastructure
{
    ...
    using ItemSearchService.Common;
    using ItemSearchService.DTOs;
    using ItemSearchService.Services.MessageBus;
    ...
    public static class ServiceCollectionExtensions
    {
           ...
           this IServiceCollection serviceCollection)
        {
            serviceCollection
                .AddDataProtection()
                .PersistKeysToFileSystem(new DirectoryInfo(@"../.aspnet/item-search-service/DataProtection-Keys"))
